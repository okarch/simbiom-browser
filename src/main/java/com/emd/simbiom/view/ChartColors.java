...
public class ChartColors {
    //main colors
    public final static Color COLOR_1 = new Color(0x3E454C);
    public final static Color COLOR_2 = new Color(0x2185C5);
    public final static Color COLOR_3 = new Color(0x7ECEFD);
    public final static Color COLOR_4 = new Color(0xFFF6E5);
    public final static Color COLOR_5 = new Color(0xFF7F66);
    //additional colors
    ...
    public static Color mapTerm( String term ) {
	// return COLORS[Math.abs(term.hashCode()) % COLORS.length];
	return new Color(term.hashCode());
    }

    public static Color fadeColor( Color basic, float perc ) {
	int r = basic.getRed();
	int g = basic.getGreen();
	int b = basic.getBlue();
